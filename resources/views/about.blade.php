...
<h3>Partners</h3>
<img src="{{ asset('image/wattlewaggler.png') }}" alt="Photo of Theophilius Tobias Wattlewaggler, Esquire" class="img-thumbnail rounded float-left mr-3" style="max-height: 180px;">
